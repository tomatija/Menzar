...
class Restavracija123LetaliskaScraper(ScraperBase):

    date = timezone.now().date()
    strDate = date.strftime("%Y-%m-%d")
    url = f"https://www.restavracija123.si/api/getDailyMenu/15144/{strDate}/"
    name = 'restavracija123Letaliska'
    display_name = "Restavracija 123 - Letališka"
