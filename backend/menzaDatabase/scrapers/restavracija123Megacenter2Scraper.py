...
class Restavracija123Megacenter2Scraper(ScraperBase):

    date = timezone.now().date()
    strDate = date.strftime("%Y-%m-%d")
    url = f"https://www.restavracija123.si/api/getDailyMenu/4698/{strDate}/"
    name = 'restavracija123Megacenter2'
    display_name = "Restavracija 123 - Mega center 2"
