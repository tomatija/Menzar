...
class Restavracija123PoslovnaScraper(ScraperBase):

    date = timezone.now().date()
    strDate = date.strftime("%Y-%m-%d")
    url = f"https://www.restavracija123.si/api/getDailyMenu/213/{strDate}/"
    name = 'restavracija123Poslovna'
    display_name = "Restavracija 123 - M poslovna stavba"
