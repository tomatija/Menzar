...
class Restavracija123PristanScraper(ScraperBase):

    date = timezone.now().date()
    strDate = date.strftime("%Y-%m-%d")
    url = f"https://www.restavracija123.si/api/getDailyMenu/17411/{strDate}/"
    name = 'restavracija123Pristan'
    display_name = "Restavracija 123 - Pristan"
